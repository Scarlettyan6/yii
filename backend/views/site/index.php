...
* This is the backend management interface.
*/
...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <div class="row" style="margin-bottom: 40px;">
            ...
            <div class="col-lg-4">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 280px; display: flex; flex-direction: column;">
                    ...
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=figure/index">
            ...
            <div class="col-lg-4">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 280px; display: flex; flex-direction: column;">
                    ...
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=timeline-event/index">
        ...
        <div class="row" style="margin-bottom: 40px;">
            <div class="col-lg-4">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 260px; display: flex; flex-direction: column;">
                    <div style="flex-grow: 1;">
                        <h2 style="color: #C00; margin-bottom: 20px; font-size: 1.4em;">
                    ...
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=media-resource/index">
            ...
            <div class="col-lg-4">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 260px; display: flex; flex-direction: column;">
                    ...
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=guestbook-message/index">
            ...
            <div class="col-lg-4">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 260px; display: flex; flex-direction: column;">
                    <div style="flex-grow: 1;">
                        <h2 style="color: #C00; margin-bottom: 20px; font-size: 1.4em;">
                            <i class="glyphicon glyphicon-file" style="font-size: 1.5em; margin-right: 10px;"></i> 战役记录管理
                        </h2>
                        <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">管理战争数据的详细记录，包括伤亡统计、战役数据等历史资料。</p>
                    </div>
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=war-record/index">
                        <i class="glyphicon glyphicon-arrow-right"></i> 管理记录
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 40px;">
            <div class="col-lg-12">
                <div class="management-card" style="background: white; border-radius: 15px; padding: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-left: 5px solid #C00; transition: all 0.3s ease; height: 220px; display: flex; flex-direction: column;">
                    <div style="flex-grow: 1;">
                        <h2 style="color: #C00; margin-bottom: 20px; font-size: 1.4em;">
                            <i class="glyphicon glyphicon-folder-open" style="font-size: 1.5em; margin-right: 10px;"></i> 战争数据集管理
                        </h2>
                        <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">管理战争数据的数据集配置，包括数据源、显示设置等元数据管理。</p>
                    </div>
                    <a class="btn" style="border-radius: 25px; padding: 12px; font-weight: bold; background: linear-gradient(45deg, #DC143C, #B22222); color: white;" href="?r=war-dataset/index">
                        <i class="glyphicon glyphicon-arrow-right"></i> 管理数据集
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="management-card" style="background: linear-gradient(135deg,rgb(255, 255, 255),rgb(255, 255, 255)); border-radius: 20px; padding: 40px; box-shadow: 0 15px 35px rgba(192,0,0,0.2); text-align: center; color: #C00; border: 2px solid #C00;">
